/**
 * V4 theme prepaint bootstrap — runs synchronously in <head>, BEFORE the app
 * bundle, to set document.documentElement.dataset.theme on the first frame.
 *
 * V4 theme authority (kept in lock-step with src/theme/theme.ts):
 *   1. A saved explicit `scli.v4.theme` preference (light|dark) wins.
